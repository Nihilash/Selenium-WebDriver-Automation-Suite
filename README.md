...
└── src/
    └── main/
        └── java/
            ...
            │   ├── Customdropdown.java
            │   ├── Dropdowns.java
            │   ├── FileUploadWithScreenshot.java
            │   ├── Iframes.java
            │   ├── PopupExample.java
            │   ├── XpathAxesFollowingPreceedingSiblings.java
            │   ├── XpathContainsStratswith.java
            │   ├── XpathForwardBackwardTraverse.java
            │   ├── XpathSiblingFunctions.java
            │   ├── Xpathattributetextmultiattri.java
            │   ├── Xpathindextraversingsibling.java
            │   └── Xpathnew1relativeAbsolute.java
            │
            ├── RobotANDAUTOMACTIONS/
            │   ├── ActionsDemo.java
            │   └── DragandDrop.java
            │
            ├── SeleniumAutomation/
            │   ├── App.java
            │   ├── FacebookLoginCssTagSelector.java
            │   ├── FacebookLoginLocators.java
            │   ├── FacebookLoginNavigate.java
            │   ├── FacebookloginXpath.java
            │   ├── ExampleSauceDemoLoginCssTagSelector.java
            │   ├── SauceDemoLoginAllLocators.java
            │   ├── SauceDemoLoginXPathMultipleUsers.java
            │   ├── TextFunctionWithXpath.java
            │   ├── WebdriverMethods.java
            │   ├── WebdriverMethods2.java
            │   ├── WebdriverMethods3.java
            │   ├── WebdriverMethods4.java
            │   ├── WebdriverMethods5.java
            │   ├── YouTubeAutomationAllLocators.java
            │   └── YouTubeAutomationTitleXPath.java
            │
            ├── SeleniumWebdriver/
