...
public class XpathForwardBackwardTraverse {
	public static void main(String[] args) throws InterruptedException {
		...
		// Start from NAME → go up → then down to PRICE
		WebElement nameElement = driver.findElement(By.className("inventory_details_name"));
		WebElement priceElement = nameElement.findElement(By.xpath("./..//div[@class='inventory_details_price']"));
		System.out.println("Forward Traversal:");
		System.out.println("Price: " + priceElement.getText());
		Thread.sleep(500);

		// ---------------- Backward Traversal using /.. ----------------
		// Start from PRICE → go up → then down to NAME
		WebElement nameFromPrice = driver.findElement(
				By.xpath("//div[@class='inventory_details_price']/../div[@class='inventory_details_name large_size']"));
